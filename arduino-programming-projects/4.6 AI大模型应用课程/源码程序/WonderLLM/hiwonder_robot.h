...
class Robot {
  public:
    ...
    /**
     * @brief Obstacle avoidance (distance can be specified)
     * 
     * @param  dis  -measured current distance
     * @param  dis_avoid  -the avoidance distance to set
     */
    ...
    /**
     * @brief Read the robot's center-of-gravity coordinate values
     * 
     * @param *val -pointer to the read coordinate values
     */
