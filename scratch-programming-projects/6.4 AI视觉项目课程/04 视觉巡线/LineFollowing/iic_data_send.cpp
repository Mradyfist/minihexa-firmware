...
static void task_process_handler(void *arg)
{
  ...
  while (true)
  {
    ...
    {
        // printf("center_x: red:%d  green:%d  blue:%d  purple:%d\r\n", send_color_data.segment1[0].center_x, \
        //                                                              send_color_data.segment1[1].center_x, \
        //                                                              send_color_data.segment1[2].center_x, \
        //                                                              send_color_data.segment1[3].center_x);
    }
  }
}
